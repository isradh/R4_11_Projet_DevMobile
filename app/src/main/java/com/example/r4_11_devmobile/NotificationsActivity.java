...
public class NotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesnotifications);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_habitats) {
                    startActivity(new Intent(NotificationsActivity.this, MonHabitatActivity.class));
                    ...
                    startActivity(new Intent(NotificationsActivity.this, PreferencesActivity.class));
                } else if (itemId == R.id.nav_monhabitat) {
                    startActivity(new Intent(NotificationsActivity.this, MonHabitatActivity.class));
                } else if (itemId == R.id.nav_profil) {
                    Intent intentMonProfil = new Intent(NotificationsActivity.this,EspaceClientActivity.class);
